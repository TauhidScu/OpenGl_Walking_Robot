...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 DrawTextXY(-2.5,0.2,2.0,0.0015,"batch-2016");
 DrawTextXY(-2.5,0.5,2.0,0.0015,"final project");
 DrawTextXY(2.5,2.2,-2.0,0.0025,"opengl");
 DrawTextXY(2.5,2.7,-2.0,0.0030,"robot");
  glFlush();
  glutSwapBuffers();
